...
var _this = this;
var GetServiceDetailsRequest = require("./index");
describe("GetServiceDetailsRequest", function () {
    it("sends a request with minimal parameters correctly", function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    expect.assertions(1);
                    return [4 /*yield*/, GetServiceDetailsRequest({
                            serviceID: "ABC123"
                        }, "TOKEN_VALUE")];
                case 1:
                    result = _a.sent();
    ...
    it("sends a request with minimal parameters and fail", function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    expect.assertions(1);
                    return [4 /*yield*/, expect(GetServiceDetailsRequest({
                            serviceID: "ABC123"
    ...
    it("sends a request with more parameters correctly", function () {
        expect.assertions(1);
        return expect(GetServiceDetailsRequest({
            numRows: "12",
            serviceID: "ABC123",
            filterCrs: ["STP"]
