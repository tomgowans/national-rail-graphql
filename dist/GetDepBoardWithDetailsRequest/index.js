 ...
 */
function GetDepBoardWithDetailsRequest(_a, tokenValue) {
    ...
    return new Promise(function (resolve, reject) {
        fetchData_1.default({
            ...
            resolve(removeArrays_1.default(result.GetDepBoardWithDetailsResponse[0].GetStationBoardResult[0]));
        })
            .catch(function (err) { return reject(err); });
    });
}
exports.default = GetDepBoardWithDetailsRequest;
