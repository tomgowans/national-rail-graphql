 ...
 */
declare function GetArrivalDepartureBoardRequest({ numRows, crs, filterCrs, filterType, timeOffset, timeWindow }: Attributes, tokenValue: string): Promise<unknown>;
export default GetArrivalDepartureBoardRequest;
