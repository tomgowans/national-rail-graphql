 ...
 */
function GetArrivalDepartureBoardRequest(_a, tokenValue) {
    ...
    return new Promise(function (resolve, reject) {
        fetchData_1.default({
            ...
            // console.dir(result);
            resolve(removeArrays_1.default(result.GetArrivalDepartureBoardResponse[0].GetStationBoardResult[0]));
        })
            .catch(function (err) { return reject(err); });
    });
}
exports.default = GetArrivalDepartureBoardRequest;
