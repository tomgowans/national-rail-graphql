 ...
 */
declare function GetFastestDeparturesWithDetailsRequest({ crs, filterList, timeOffset, timeWindow }: Attributes, tokenValue: string): Promise<unknown>;
export default GetFastestDeparturesWithDetailsRequest;
