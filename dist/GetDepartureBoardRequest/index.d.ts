 ...
 * @param {Array<string> || null} filterCrs (string, 3 characters, alphabetic): The CRS code of either an origin or destination location to filter in. Optional.
 ...
 */
declare function GetDepartureBoardRequest({ numRows, crs, filterCrs, filterType, timeOffset, timeWindow }: Attributes, tokenValue: string): Promise<unknown>;
export default GetDepartureBoardRequest;
