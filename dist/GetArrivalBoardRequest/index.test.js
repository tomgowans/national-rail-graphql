...
var _this = this;
var GetArrivalBoardRequest = require("./index");
describe("GetArrivalBoardRequest", function () {
    it("sends a request with minimal parameters correctly", function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    expect.assertions(1);
                    return [4 /*yield*/, GetArrivalBoardRequest({
                            crs: "ECR"
                        }, "TOKEN_VALUE")];
                case 1:
                    result = _a.sent();
    ...
    it("sends a request with minimal parameters and fail", function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    expect.assertions(1);
                    return [4 /*yield*/, expect(GetArrivalBoardRequest({
                            crs: "ECR"
    ...
    it("sends a request with more parameters correctly", function () {
        expect.assertions(1);
        return expect(GetArrivalBoardRequest({
            numRows: "12",
            crs: "ECR",
            filterCrs: ["STP"]
